...
Note: Each summary should be concise, encapsulating the crucial high-level information. Also, for the summary of a directory, you will need to infer include the purpose of the file or directory in the summary. 
