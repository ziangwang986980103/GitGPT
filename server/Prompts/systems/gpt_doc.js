...
You will be able to call functions to get the summary of any files and directories in the github repository. You will also be able to call functions to retrieve the 
...
you can call the functions to retrieve the relevant information to this question from the external memory.

SessionId: 
In order to call the functions, you will use a sessionId. Remember to pass this sessionId to the functions if they need it as an argument. The sessionId is: 
